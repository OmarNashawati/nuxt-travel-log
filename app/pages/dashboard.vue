    ...
    <div class="bg-base-100 transition-all duration-300 shrink-0" :class="{ 'w-64': isSidebarOpen, 'w-16': !isSidebarOpen }">
      ...
      <div class="flex flex-col">
        ...
        <div v-if="sidebarStore.loading" class="px-4">
          <div class="skeleton h-4 w-full px-4" />
        </div>

        <div v-if="!sidebarStore.loading && sidebarStore.sidebarItems.length" class="flex flex-col flex-1 overflow-y-auto overflow-x-hidden ">
          <SidebarButton 
